...
namespace Utilities.AudioSystem
{
	public class AudioManager : Singleton<AudioManager>
	{
		...
		{
			get => PlayerPrefs.GetInt(PlayerPrefNames.IS_SOUND_MUTED, 0).Equals(1);
			set => PlayerPrefs.SetInt(PlayerPrefNames.IS_SOUND_MUTED, value ? 1 : 0);
		}
		public bool IsMusicMuted
		{
			get => PlayerPrefs.GetInt(PlayerPrefNames.IS_MUSIC_MUTED, 0).Equals(1);
			set => PlayerPrefs.SetInt(PlayerPrefNames.IS_MUSIC_MUTED, value ? 1 : 0);
		}
